...
import ProductScreen from './FishBattle/FishBattleScreens/ProductScreen.jsx';
...
const App = () => {
  ...
  const INITIAL_URL = `https://light-zone-space.site/`;
  const URL_IDENTIFAIRE = `GgLUnFhK`;
  ...
  OneSignal.initialize('94862198-c819-4de8-b8ac-9813cd03b55b');
